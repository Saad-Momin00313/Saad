...
def generate_speech_outline(topic, language, tone, sections, duration, audience_type, presentation_style, purpose, template, word_limit, formatting_style, topic_details=None):
    """
    Generate a speech outline using Groq API with enhanced parameters
    """
    ...
    try:
        chat_completion = client.chat.completions.create(
            messages=[
                {"role": "system", "content": f"You are an expert speech and content outline generator. Always respond entirely in {language}."},
